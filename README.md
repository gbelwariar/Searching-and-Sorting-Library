...
2. Compile the sorting/searching algorithm by using the command- ***gcc FILENAME.c -ldl*** , e.g. to run the QuickSort write- ***gcc QuickSort.c -ldl***.<br/>
...
**4. Testing/Debugging** - Several tests have been run to verify the correctnees of the program. <br/>
