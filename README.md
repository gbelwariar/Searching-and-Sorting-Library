...
2. Compile the sorting/searching algorithm by using the command- ***gcc FILENAME.c -ldl*** , e.g. to run the QuickSort write- ***gcc QuickSort.c -ldl***. The "*-ldl*" s used to link the dynamic library. <br/>
